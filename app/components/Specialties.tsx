  ...
  return (
    <div className="glass-card glass-card-hover p-6 md:p-8 relative overflow-hidden group h-full flex flex-col">
      <div className="relative z-10 flex flex-col h-full">
        {/* Icon */}
        <div className="w-14 h-14 rounded-xl bg-[var(--surface-light)] border border-[var(--surface-border)] text-[var(--primary-dark)] flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
          {specialty.icon}
        </div>

        {/* Title */}
        <h3 className="text-2xl text-[var(--foreground)] mb-1">{specialty.title}</h3>
        <p className="text-sm font-medium text-[var(--primary-dark)] mb-4">
          {specialty.subtitle}
        </p>
...
export default function Specialties() {
  ...
  return (
    <section id="especialidades" ref={sectionRef} className="section-padding relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[rgba(94,123,153,0.03)] to-transparent pointer-events-none" />
