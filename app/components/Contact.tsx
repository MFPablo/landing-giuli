...
const contactLinks = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/giuliana-covello/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          {contactLinks.map((link) => (
            <a
              ...
              className="w-12 h-12 rounded-xl border border-[var(--surface-border)] bg-[var(--surface)] flex items-center justify-center text-[var(--muted)] hover:text-white hover:border-[var(--primary)] hover:bg-[rgba(14,165,233,0.1)] transition-all duration-300"
            >
              {link.icon}
            </a>
          ))}
